...
router.register(r'history', MatchHistoryViewSet) # history/{id} as for (profile id)  for user game history
...
# user-management
    ...
    # path('acount-updater/',UpdateUserInfos.as_view(), name='acount-updater'),
