...
export default function Settings() {
  ...
  return (
    <div className="size-full md:py-4 md:pl-6 overflow-auto">
      <div className="costum-little-shadow size-full md:rounded-[50px] overflow-hidden bg-[#00000099] flex flex-col-reverse lg:flex-row">
        ...
        <div className="w-full h-[90%] lg:h-full lg:w-5/6 xl:w-4/6 custom-scrollbar-container overflow-y-scroll">
          {renderContent()}
        </div>
      </div>
    </div>
