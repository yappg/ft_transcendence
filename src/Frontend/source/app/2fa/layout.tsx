...
//<Card className="inline-block size-full gap-8 p-4 costum-little-shadow transition-all md:w-full lg:mt-[10%] lg:h-[600px] lg:rounded-[50px] xl:max-w-[1100px] 2xl:w-3/5 lg:max-w-[900px]">
