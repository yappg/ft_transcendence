...
//     <div className="w-full h-fit lg:size-full xl:w-[65%] flex items-start justify-start flex-col gap-4">
//       <div className="w-full lg:h-[100px] h-[50px] flex flex-row gap-3 overflow-hidden p-5 xl:p-2">
...
//             <h1 className="text-white font-bold text-center">This Profile is Private</h1>
//           </div>
//          ) : (
//       <div className="lg:h-[500px] sm:h-[200px] h-[600px] bg-red-500 w-full flex items-center justify-between xl:px-5 sm:flex-row flex-col gap-8 overflow-y-scroll custom-scrollbar-container ">
//         <div className="custom-scrollbar-container w-full  h-[300px] overflow-y-scroll md:w-[48%]  bg-[#4C4D4E] rounded-[50px] shadow-2xl">
...
//             <div className="w-full sticky bottom-0 bg-[#4C4D4E] Profilez-10 h-[50px] border-t-2 border-[#B8B8B8] flex items-center justify-end gap-4 px-10">
...
//           </Link>
//         </div>
//         <div className="custom-scrollbar-container w-full h-[300px] overflow-y-scroll md:w-[48%]  bg-[#4C4D4E] rounded-[50px] shadow-2xl flex flex-col">
