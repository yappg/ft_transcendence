...
//   return (
//     <div
//       className="flex h-auto w-full flex-row items-center justify-between border-b-2 border-[#1C1C1C] border-opacity-[40%] bg-black-crd pl-2 sm:pl-4 lg:px-5"
//       style={{
//         ...customStyles,
//       }}
//     >
...
//         </div>
//       </div>
//       <div className="flex w-[23%] h-full items-center justify-end">{messagesLink}</div>
//     </div>
//   );
// };
