      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <div className="dark:bg-linear-gradient-dark bg-linear-gradient flex size-full flex-col">
              {children}
            </div>
          </SheetContent>
        </Sheet>
  ...
  return (
    ...
    >
      <IconMenu2
        ...
        stroke={1.5}
        className="size-[70px] border-none text-[rgba(28,28,28,0.9)] text-white"
      />
    </Button>
  );
});
