  ...
  return (
    <div className="size-full 2xl:p-28">
      <div className="custom-scrollbar-container h-[calc(100%-200px)] overflow-y-scroll bg-[#4C4D4E] shadow-2xl 2xl:rounded-[50px]">
        <div className="bg-black-crd size-full items-center justify-center dark:bg-transparent ">
          {blockedList.length > 0 ? (
            ...
            <div className="font-dayson flex items-center justify-center text-xl text-white ">
