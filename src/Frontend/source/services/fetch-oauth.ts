...
export class OAuthClient {
  ...
  static async intra42() {
    this.fetchWithOAuth(
      'https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-4aedcd9bbfe99586bd8aab9967a260dd24e4a1459620fe008ae457eae916624c&redirect_uri=http%3A%2F%2F127.0.0.1%3A3000%2Fhome&response_type=code'
    );
  }
}
